...
- [AGENTS.md](AGENTS.md) — agent workflow, coding style reference
- [CONTRIBUTING.md](CONTRIBUTING.md) — contribution rules (Spanish)
- [DESIGN.md](DESIGN.md) — design tokens, colors, typography
- [LLM_INIT.md](LLM_INIT.md) — project context for AI agents
- [UX_QA_CHECKLIST.md](UX_QA_CHECKLIST.md) — visual QA before merge
- [.agent/audit/GAP_ANALYSIS.md](.agent/audit/GAP_ANALYSIS.md) — Phase 2 technical backlog
